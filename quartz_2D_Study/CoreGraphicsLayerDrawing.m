...
#import "CoreGraphicsLayerDrawing.h"

@implementation CoreGraphicsLayerDrawing
...
- (void)drawRect:(CGRect)rect {
    ...
    CGRect flagRect = CGRectMake(0, 0, 200, 150);
    
    myDrawFlag(currentRef, &flagRect);
